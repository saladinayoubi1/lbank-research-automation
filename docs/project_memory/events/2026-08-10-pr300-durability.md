...
- Squash merge result: `60983e2d3233e11fefe357d7378cfae8b15fdad6`.
- Current main after subsequent public-data refresh: `eb3ce947eda02cda54d37d39e8deb2f9f82e66fe`.
...
Recovery semantics:
- Laptop power-off and network/DNS outage are distinct failure classes and must not be inferred from each other.
