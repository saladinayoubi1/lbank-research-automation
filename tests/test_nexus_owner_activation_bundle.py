...
def test_backup_paths_and_every_backup_domain_are_verified() -> None:
    ...
    for expected in (
        ...
        "BACKUP_JOURNAL_HASH_MISMATCH", "BACKUP_MANIFEST_HASH_MISMATCH",
        "ExpectedProductDataManifestSha256", "ExpectedShortcutManifestSha256",
        "ExpectedGlobalSyncManifestSha256", "ORIGINAL_OWNER_JOURNAL",
