...
def test_phase4_event_workload_runs_only_canonical_event_store_suite(tmp_path):
    ...
    assert result["evidence"]["suite"] == ["tests/test_paper_event_store.py"]
    assert result["evidence"]["purpose"] == "deterministic-event-store-ownership-replay-and-corruption-proof"
