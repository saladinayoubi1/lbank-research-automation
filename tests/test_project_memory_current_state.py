...
def test_project_memory_keeps_real_time_and_production_gates_fail_closed() -> None:
    ...
    assert (
        prospective["verified_completed_hour4_bars"] < prospective["required_completed_hour4_bars"]
        or prospective["verified_elapsed_day_floor"] < prospective["required_elapsed_days"]
    )
