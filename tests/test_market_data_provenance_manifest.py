...
from market_data_provenance_manifest import ProvenanceManifestError, SUPPORTED_TIMEFRAMES_MS, build_provenance_manifest, validate_provenance_manifest
...
def _manifest(candles: list[dict[str, object]] | None = None, **overrides: object) -> dict[str, object]:
    args: dict[str, object] = {
        "source": "Binance", "market_type": "spot", "source_symbol": "BTCUSDT", "canonical_symbol": "BTC/USDT",
        "timeframe": "15m", "endpoint_contract": "binance-spot-rest-api-v3-klines", "mapping_policy_version": "1.0.0",
        "retrieval_start_ms": 0, "retrieval_end_ms": 900_000, "candles": candles or _candles(),
