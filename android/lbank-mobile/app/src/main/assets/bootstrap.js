(()=>{
  ...
  window.addEventListener('DOMContentLoaded',()=>{
    initialLoad();
    const button=document.getElementById('checkUpdate');if(button)button.addEventListener('click',()=>backgroundCheck(true));
    setInterval(()=>backgroundCheck(false),6*60*60*1000);
  });
})();
